...
+        public static TInteger ConvertToInteger<TInteger>(NFloat value) where TInteger : IBinaryInteger<TInteger>;
+        public static TInteger ConvertToIntegerNative<TInteger>(NFloat value) where TInteger : IBinaryInteger<TInteger>;
+        public static NFloat MultiplyAddEstimate(NFloat left, NFloat right, NFloat addend);
     }
