...
+            public bool TryRemove(TAlternateKey key, [MaybeNullWhenAttribute(false)] out TKey actualKey, [MaybeNullWhenAttribute(false)] out TValue value);
+            public bool TryRemove(TAlternateKey key, [MaybeNullWhenAttribute(false)] out TValue value);
+        }
     }
 }
```
