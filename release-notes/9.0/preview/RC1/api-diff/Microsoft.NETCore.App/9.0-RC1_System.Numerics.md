...
+        static BigInteger INumberBase<BigInteger>.MultiplyAddEstimate(BigInteger left, BigInteger right, BigInteger addend);
     }
...
+        static TInteger ConvertToInteger<TInteger>(TSelf value);
+        static TInteger ConvertToIntegerNative<TInteger>(TSelf value);
     }
...
+        static TSelf MultiplyAddEstimate(TSelf left, TSelf right, TSelf addend);
     }
