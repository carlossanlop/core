...
+        public JsonArray([ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<JsonNode?> items);
+        public JsonArray(JsonNodeOptions options, [ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<JsonNode?> items);
     }
