...
+        public static string Combine([ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<string> paths);
+        public static string Join([ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<string?> paths);
     }
...
+        public virtual void Write([StringSyntaxAttribute("CompositeFormat")] string format, [ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<object?> arg);
+        public virtual void WriteLine([StringSyntaxAttribute("CompositeFormat")] string format, [ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<object?> arg);
     }
 }
```
