...
+        public static FrozenSet<T> Create<T>(IEqualityComparer<T>? equalityComparer, [ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<T> source);
+        public static FrozenSet<T> Create<T>([ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<T> source);
     }
...
+    [CollectionBuilderAttribute(typeof(FrozenSet), "Create")]
+    public abstract class FrozenSet<T> : ICollection, ICollection<T>, IEnumerable, IEnumerable<T>, IReadOnlyCollection<T>, IReadOnlySet<T>, ISet<T> {
