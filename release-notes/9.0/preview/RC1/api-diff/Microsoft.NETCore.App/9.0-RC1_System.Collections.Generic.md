...
+        public static void AddRange<T>(this List<T> list, [ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<T> source);
-        public static void InsertRange<T>(this List<T> list, int index, ReadOnlySpan<T> source);
+        public static void InsertRange<T>(this List<T> list, int index, [ParamCollectionAttribute, ScopedRefAttribute] ReadOnlySpan<T> source);
     }
...
+            public bool Remove(TAlternateKey key, [MaybeNullWhenAttribute(false)] out TKey actualKey, [MaybeNullWhenAttribute(false)] out TValue value);
+            public bool TryAdd(TAlternateKey key, TValue value);
+            public bool TryGetValue(TAlternateKey key, [MaybeNullWhenAttribute(false)] out TKey actualKey, [MaybeNullWhenAttribute(false)] out TValue value);
+            public bool TryGetValue(TAlternateKey key, [MaybeNullWhenAttribute(false)] out TValue value);
+        }
     }
...
+            public bool TryGetValue(TAlternate equalValue, [MaybeNullWhenAttribute(false)] out T actualValue);
+        }
     }
...
+        public bool Remove(TKey key, [MaybeNullWhenAttribute(false)] out TValue value);
...
+        public bool Remove(TElement element, [MaybeNullWhenAttribute(false)] out TElement removedElement, [MaybeNullWhenAttribute(false)] out TPriority priority, IEqualityComparer<TElement>? equalityComparer = null);
