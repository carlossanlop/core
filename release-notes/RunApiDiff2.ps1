...
# Example:
# .\RunApiDiff2.ps1 -PreviousDotNetVersion 8.0 -PreviousPreviewOrRC preview -PreviousPreviewNumberVersion 2 -CurrentDotNetVersion 8.0 -CurrentPreviewOrRC preview -CurrentPreviewNumberVersion 3 -CoreRepo D:\core -SdkRepo D:\sdk -TmpFolder D:\tmp
...
Function RunApiDiff2
{
    ...
    RunCommand "$apiDiffExe -o $outputFolder -b $beforeFolder -a $afterFolder -rb $beforeFolder -ra $afterFolder"
}
...
RunApiDiff2 $apiDiffExe $netCoreTargetFolder $netCoreBeforeDllFolder $netCoreAfterDllFolder
RunApiDiff2 $apiDiffExe $aspNetCoreTargetFolder $aspNetCoreBeforeDllFolder $aspNetCoreAfterDllFolder
RunApiDiff2 $apiDiffExe $windowsDesktopTargetFolder $windowsDesktopBeforeDllFolder $windowsDesktopAfterDllFolder
